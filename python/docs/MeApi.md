# debitura_debt_collection.MeApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**me_get**](MeApi.md#me_get) | **GET** /me | Verifies the provided authentication and returns the current Creditor profile


# **me_get**
> DebituraWebExternalCustomerAPIModelsMeCreditorMeApiDTO me_get()
...
with debitura_debt_collection.ApiClient(configuration) as api_client:
    ...
    api_instance = debitura_debt_collection.MeApi(api_client)

    try:
        # Verifies the provided authentication and returns the current Creditor profile
        api_response = api_instance.me_get()
        print("The response of MeApi->me_get:\n")
        pprint(api_response)
...
[**DebituraWebExternalCustomerAPIModelsMeCreditorMeApiDTO**](DebituraWebExternalCustomerAPIModelsMeCreditorMeApiDTO.md)
