...
class DebituraWebExternalCustomerAPIModelsMeCreditorMeApiDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "companyName", "companyRegistrationNumber", "address", "zipCode", "city", "state", "country", "officeEmail", "officePhone"]
