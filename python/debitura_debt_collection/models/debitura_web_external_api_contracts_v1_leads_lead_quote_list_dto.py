...
class DebituraWebExternalApiContractsV1LeadsLeadQuoteListDto(BaseModel):
    """
    V1 Lead Quote list response for external customer APIs
    """ # noqa: E501
    quotes: Optional[List[DebituraWebExternalApiContractsV1LeadsLeadQuoteDto]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "quotes": [DebituraWebExternalApiContractsV1LeadsLeadQuoteDto.from_dict(_item) for _item in obj["quotes"]] if obj.get("quotes") is not None else None
        })
        return _obj
