...
class DebituraWebExternalApiContractsV1CasesAdvanceTestCaseResponse(BaseModel):
    """
    Response from POST /test/cases/{id}/advance.
    """ # noqa: E501
    advanced: Optional[StrictBool] = Field(default=None, description="True if the case was advanced in this call; false if it was already at or past the target state (no-op).")
    state: Optional[StrictStr] = Field(default=None, description="The current state of the case after this call. One of: \"Active\", \"Closed:Paid\", \"Closed:NoPayment\", \"Closed\" (for other close codes).")
    __properties: ClassVar[List[str]] = ["advanced", "state"]
