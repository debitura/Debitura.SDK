...
class DebituraWebExternalApiContractsV1LeadsLeadDetailDto(BaseModel):
    """
    ...
    is_max_bid_count_reached: Optional[StrictBool] = Field(default=None, alias="isMaxBidCountReached")
    outcome: Optional[StrictStr] = None
    request: Optional[StrictStr] = None
    existing_fees: Optional[StrictStr] = Field(default=None, alias="existingFees")
    ...
    __properties: ClassVar[List[str]] = ["quoteRequestId", "caseId", "status", "leadFlowStatus", "quoteType", "maxQuotes", "currentQuotesCount", "isMaxBidCountReached", "outcome", "request", "existingFees", "dateCreated", "dateQualified", "leadsDoneOffered", "dateReminderSent", "dateReminderTwoSent", "dateOutcomeSelected"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if existing_fees (nullable) is None
        # and model_fields_set contains the field
        if self.existing_fees is None and "existing_fees" in self.model_fields_set:
            _dict['existingFees'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isMaxBidCountReached": obj.get("isMaxBidCountReached"),
            "outcome": obj.get("outcome"),
            "request": obj.get("request"),
            "existingFees": obj.get("existingFees"),
