...
class DebituraDomainModelCollectionPartnerLogicsCollectionPartnersSurveyCadenceMode(int, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DebituraDomainModelCollectionPartnerLogicsCollectionPartnersSurveyCadenceMode from a JSON string"""
