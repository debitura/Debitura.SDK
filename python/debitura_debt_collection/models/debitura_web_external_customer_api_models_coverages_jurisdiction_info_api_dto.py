...
class DebituraWebExternalCustomerAPIModelsCoveragesJurisdictionInfoApiDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "country", "countryAlpha2", "usStateAlpha2"]
