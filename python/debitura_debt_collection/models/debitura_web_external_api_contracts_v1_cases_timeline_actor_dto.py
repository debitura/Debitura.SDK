...
class DebituraWebExternalApiContractsV1CasesTimelineActorDto(BaseModel):
    """
    Represents the actor (person or system) that performed a timeline action.
    """ # noqa: E501
    type: Optional[StrictStr] = Field(description="The type of actor. One of: \"System\", \"Creditor user\", \"Partner user\".")
    name: Optional[StrictStr] = Field(default=None, description="Display name of the actor, if available.")
