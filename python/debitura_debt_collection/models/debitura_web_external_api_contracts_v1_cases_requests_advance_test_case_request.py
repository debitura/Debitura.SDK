...
class DebituraWebExternalApiContractsV1CasesRequestsAdvanceTestCaseRequest(BaseModel):
    """
    Request to advance a test case to a known lifecycle state.
    """ # noqa: E501
    to: Optional[StrictStr] = Field(description="The target state to advance the case to. Valid values: \"Active\", \"Closed:Paid\", \"Closed:NoPayment\"")
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Payment amount (required when To is \"Closed:Paid\"). Must be a positive value in the case currency.")
    __properties: ClassVar[List[str]] = ["to", "amount"]
