...
class DebituraWebExternalApiContractsV1CasesInvoiceAllocationOutstandingDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["principal", "interest", "reminderFees", "collectionFees"]
