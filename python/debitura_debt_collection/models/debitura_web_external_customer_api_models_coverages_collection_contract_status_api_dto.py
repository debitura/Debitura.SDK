...
class DebituraWebExternalCustomerAPIModelsCoveragesCollectionContractStatusApiDTO(BaseModel):
    """
    DebituraWebExternalCustomerAPIModelsCoveragesCollectionContractStatusApiDTO
    """ # noqa: E501
    signed: Optional[StrictBool] = None
    requires_resigning: Optional[StrictBool] = Field(default=None, alias="requiresResigning")
    invalidation_reason: Optional[StrictStr] = Field(default=None, alias="invalidationReason")
    terms_url: Optional[StrictStr] = Field(default=None, alias="termsUrl")
    solution_url: Optional[StrictStr] = Field(default=None, alias="solutionUrl")
