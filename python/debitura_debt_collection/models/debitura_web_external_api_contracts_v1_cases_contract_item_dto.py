...
class DebituraWebExternalApiContractsV1CasesContractItemDto(BaseModel):
    """
    Status of an individual contract (SDCA, PoA, or Pricing Appendix).
    """ # noqa: E501
    signed: Optional[StrictBool] = Field(default=None, description="Whether the contract has been signed.")
    requires_resigning: Optional[StrictBool] = Field(default=None, description="Whether the contract needs to be re-signed (e.g., due to contract template updates).", alias="requiresResigning")
    solution_url: Optional[StrictStr] = Field(default=None, description="URL where the creditor can sign or re-sign the contract. Null if the contract is signed and current. The URL is context-aware: referral partner tokens get referral onboarding URLs, regular API keys get standard creditor app URLs.", alias="solutionUrl")
    __properties: ClassVar[List[str]] = ["signed", "requiresResigning", "solutionUrl"]
