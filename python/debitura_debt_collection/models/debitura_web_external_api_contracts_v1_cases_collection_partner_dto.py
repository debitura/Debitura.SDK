...
class DebituraWebExternalApiContractsV1CasesCollectionPartnerDto(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if public_site (nullable) is None
        # and model_fields_set contains the field
        if self.public_site is None and "public_site" in self.model_fields_set:
            _dict['publicSite'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "publicSite": obj.get("publicSite"),
            "surveyCadenceMode": obj.get("surveyCadenceMode")
        })
        return _obj
