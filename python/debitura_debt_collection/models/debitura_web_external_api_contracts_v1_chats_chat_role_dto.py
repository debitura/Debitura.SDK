...
class DebituraWebExternalApiContractsV1ChatsChatRoleDto(int, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DebituraWebExternalApiContractsV1ChatsChatRoleDto from a JSON string"""
