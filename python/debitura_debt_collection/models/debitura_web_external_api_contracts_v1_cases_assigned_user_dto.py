...
class DebituraWebExternalApiContractsV1CasesAssignedUserDto(BaseModel):
    """
    Represents the creditor team member assigned to a case.
    """ # noqa: E501
    email: Optional[StrictStr] = Field(default=None, description="The assigned user's email address.")
    name: Optional[StrictStr] = Field(default=None, description="The assigned user's full name.")
