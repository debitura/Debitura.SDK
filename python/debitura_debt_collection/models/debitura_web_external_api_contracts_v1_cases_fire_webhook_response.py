...
class DebituraWebExternalApiContractsV1CasesFireWebhookResponse(BaseModel):
    """
    Result of the `POST /test/webhooks/fire` endpoint.
    """ # noqa: E501
    event_type: Optional[StrictStr] = Field(default=None, description="The event type that was fired (e.g. \"case.updated\").", alias="eventType")
    case_id: Optional[StrictStr] = Field(default=None, description="The case ID the event was fired for.", alias="caseId")
    enqueued_count: Optional[StrictInt] = Field(default=None, description="Number of webhook delivery jobs enqueued. Zero means no active test subscriptions were found for this event type.", alias="enqueuedCount")
    __properties: ClassVar[List[str]] = ["eventType", "caseId", "enqueuedCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enqueuedCount": obj.get("enqueuedCount")
        })
        return _obj
