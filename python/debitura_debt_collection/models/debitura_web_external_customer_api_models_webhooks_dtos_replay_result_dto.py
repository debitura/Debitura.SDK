...
class DebituraWebExternalCustomerAPIModelsWebhooksDtosReplayResultDto(BaseModel):
    """
    Result of a webhook event replay operation.
    """ # noqa: E501
    events_replayed: Optional[StrictInt] = Field(default=None, description="Number of events that were re-enqueued for delivery.", alias="eventsReplayed")
    __properties: ClassVar[List[str]] = ["eventsReplayed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "eventsReplayed": obj.get("eventsReplayed")
        })
        return _obj
