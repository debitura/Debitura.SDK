...
class DebituraWebExternalCustomerAPIModelsWebhooksRequestsReplayRequestDto(BaseModel):
    """
    Request to replay events from a specific timestamp.
    """ # noqa: E501
    since_utc: datetime = Field(description="Replay all case.created events since this timestamp (UTC).", alias="sinceUtc")
    __properties: ClassVar[List[str]] = ["sinceUtc"]
