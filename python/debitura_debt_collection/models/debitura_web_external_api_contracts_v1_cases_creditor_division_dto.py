...
class DebituraWebExternalApiContractsV1CasesCreditorDivisionDto(BaseModel):
    """
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the division")
    name: Optional[StrictStr] = Field(default=None, description="Name of the division")
