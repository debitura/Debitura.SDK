...
class DebituraWebExternalApiContractsV1CasesPartnerAssignmentDto(BaseModel):
    """
    Information about the collection partner assigned to this case.
    """ # noqa: E501
    collection_partner_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the collection partner.", alias="collectionPartnerId")
    partner_name: Optional[StrictStr] = Field(default=None, description="Display name of the collection partner company.", alias="partnerName")
    partner_country: Optional[StrictStr] = Field(default=None, description="ISO 3166-1 alpha-2 country code for the partner's primary country.", alias="partnerCountry")
    __properties: ClassVar[List[str]] = ["collectionPartnerId", "partnerName", "partnerCountry"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if partner_country (nullable) is None
        # and model_fields_set contains the field
        if self.partner_country is None and "partner_country" in self.model_fields_set:
            _dict['partnerCountry'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "partnerCountry": obj.get("partnerCountry")
        })
        return _obj
