...
class DebituraWebExternalApiContractsV1CasesCaseTimelineResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    items: Optional[List[DebituraWebExternalApiContractsV1CasesTimelineItemDto]] = Field(description="Chronological list of events on the case.")
    current_engagement_phase: Optional[StrictStr] = Field(default=None, description="The current engagement phase of the case, sourced from CaseEngagement.CurrentPhase. Possible values: \"Pre-legal\", \"Legal\", \"Enforcement\". Null when no active engagement exists (e.g. case not yet assigned to a partner).", alias="currentEngagementPhase")
    __properties: ClassVar[List[str]] = ["items", "currentEngagementPhase"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DebituraWebExternalApiContractsV1CasesTimelineItemDto.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
