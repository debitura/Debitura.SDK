...
class DebituraDomainServicesCaseValidationCaseValidationStatusDto(BaseModel):
    """
    DebituraDomainServicesCaseValidationCaseValidationStatusDto
    """ # noqa: E501
    needs_info: Optional[StrictBool] = Field(default=None, alias="needsInfo")
    creditor_responded_at: Optional[datetime] = Field(default=None, alias="creditorRespondedAt")
    items: Optional[List[DebituraDomainServicesCaseValidationCaseValidationItemDto]] = None
    __properties: ClassVar[List[str]] = ["needsInfo", "creditorRespondedAt", "items"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.items:
            ...
            _dict['items'] = _items
        # set to None if creditor_responded_at (nullable) is None
        # and model_fields_set contains the field
        if self.creditor_responded_at is None and "creditor_responded_at" in self.model_fields_set:
            _dict['creditorRespondedAt'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "needsInfo": obj.get("needsInfo"),
            "creditorRespondedAt": obj.get("creditorRespondedAt"),
            "items": [DebituraDomainServicesCaseValidationCaseValidationItemDto.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
