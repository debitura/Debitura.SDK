...
class DebituraWebExternalApiContractsV1TasksTaskActionDto(BaseModel):
    """
    ...
    """ # noqa: E501
    method: Optional[StrictStr] = Field(default=None, description="HTTP method to use, e.g. `\"POST\"`.")
    path: Optional[StrictStr] = Field(default=None, description="Path template for the resolving call, e.g. `\"/cases/{caseId}/chats\"`. Relative to the API's base URL.")
