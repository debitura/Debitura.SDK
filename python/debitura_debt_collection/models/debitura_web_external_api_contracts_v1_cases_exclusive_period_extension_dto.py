...
class DebituraWebExternalApiContractsV1CasesExclusivePeriodExtensionDto(BaseModel):
    """
    A single extension event in the exclusive period chain.
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="What triggered this extension: PromiseToPay, PaymentAgreement, Payment, or Manual.")
    event_date: Optional[datetime] = Field(default=None, description="When the extension period started (i.e. when the trigger event occurred).", alias="eventDate")
    new_end_date: Optional[datetime] = Field(default=None, description="The new period end date after this extension was applied.", alias="newEndDate")
    __properties: ClassVar[List[str]] = ["type", "eventDate", "newEndDate"]
