...
class DebituraWebExternalApiContractsV1DivisionsDivisionListDto(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if divisions (nullable) is None
        # and model_fields_set contains the field
        if self.divisions is None and "divisions" in self.model_fields_set:
            _dict['divisions'] = None
