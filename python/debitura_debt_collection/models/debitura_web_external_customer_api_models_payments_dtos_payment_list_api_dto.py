...
class DebituraWebExternalCustomerAPIModelsPaymentsDtosPaymentListApiDTO(BaseModel):
    """
    DebituraWebExternalCustomerAPIModelsPaymentsDtosPaymentListApiDTO
    """ # noqa: E501
    page: DebituraDomainModelBasePageData
    payments: Optional[List[DebituraWebExternalApiContractsV1PaymentsPaymentDto]] = None
    __properties: ClassVar[List[str]] = ["page", "payments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payments": [DebituraWebExternalApiContractsV1PaymentsPaymentDto.from_dict(_item) for _item in obj["payments"]] if obj.get("payments") is not None else None
        })
        return _obj
