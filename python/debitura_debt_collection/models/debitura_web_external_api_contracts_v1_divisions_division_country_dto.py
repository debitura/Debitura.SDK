...
class DebituraWebExternalApiContractsV1DivisionsDivisionCountryDto(BaseModel):
    """
    DebituraWebExternalApiContractsV1DivisionsDivisionCountryDto
    """ # noqa: E501
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    alpha2: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "name", "alpha2"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DebituraWebExternalApiContractsV1DivisionsDivisionCountryDto from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if alpha2 (nullable) is None
        # and model_fields_set contains the field
        if self.alpha2 is None and "alpha2" in self.model_fields_set:
            _dict['alpha2'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DebituraWebExternalApiContractsV1DivisionsDivisionCountryDto from a dict"""
        if obj is None:
            return None
