...
from debitura_debt_collection.api_response import ApiResponse, T as ApiResponseT
import debitura_debt_collection.models
from debitura_debt_collection import rest
from debitura_debt_collection.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(debitura_debt_collection.models, klass)
