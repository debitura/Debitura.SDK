...
class ContractsApi:
    ...
    @validate_call
    def contracts_debt_collection_status_get(
        self,
        ...
        _param = self._contracts_debt_collection_status_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DebituraWebExternalCustomerAPIModelsCoveragesCollectionContractStatusApiDTO",
        }
    ...
    @validate_call
    def contracts_debt_collection_status_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DebituraWebExternalCustomerAPIModelsCoveragesCollectionContractStatusApiDTO]:
        """Get debt collection contract status
    ...
    @validate_call
    def contracts_debt_collection_status_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _contracts_debt_collection_status_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/contracts/debt-collection/status',
