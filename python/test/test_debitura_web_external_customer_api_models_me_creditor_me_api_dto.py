...
class TestDebituraWebExternalCustomerAPIModelsMeCreditorMeApiDTO(unittest.TestCase):
    """DebituraWebExternalCustomerAPIModelsMeCreditorMeApiDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalCustomerAPIModelsMeCreditorMeApiDTO:
        """Test DebituraWebExternalCustomerAPIModelsMeCreditorMeApiDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalCustomerAPIModelsMeCreditorMeApiDTO`
        """
        model = DebituraWebExternalCustomerAPIModelsMeCreditorMeApiDTO()
        if include_optional:
            return DebituraWebExternalCustomerAPIModelsMeCreditorMeApiDTO(
                id = '',
                company_name = '',
    ...
    def testDebituraWebExternalCustomerAPIModelsMeCreditorMeApiDTO(self):
        """Test DebituraWebExternalCustomerAPIModelsMeCreditorMeApiDTO"""
