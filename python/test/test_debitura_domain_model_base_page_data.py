...
class TestDebituraDomainModelBasePageData(unittest.TestCase):
    """DebituraDomainModelBasePageData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraDomainModelBasePageData:
        """Test DebituraDomainModelBasePageData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraDomainModelBasePageData`
        """
        model = DebituraDomainModelBasePageData()
        if include_optional:
            return DebituraDomainModelBasePageData(
                total_results = 56,
                page_size = 56,
                current_page = 56,
                response_count = 56,
    ...
    def testDebituraDomainModelBasePageData(self):
        """Test DebituraDomainModelBasePageData"""
