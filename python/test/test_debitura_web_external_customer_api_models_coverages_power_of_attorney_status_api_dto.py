...
class TestDebituraWebExternalCustomerAPIModelsCoveragesPowerOfAttorneyStatusApiDTO(unittest.TestCase):
    """DebituraWebExternalCustomerAPIModelsCoveragesPowerOfAttorneyStatusApiDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalCustomerAPIModelsCoveragesPowerOfAttorneyStatusApiDTO:
        """Test DebituraWebExternalCustomerAPIModelsCoveragesPowerOfAttorneyStatusApiDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalCustomerAPIModelsCoveragesPowerOfAttorneyStatusApiDTO`
        """
        model = DebituraWebExternalCustomerAPIModelsCoveragesPowerOfAttorneyStatusApiDTO()
        if include_optional:
            return DebituraWebExternalCustomerAPIModelsCoveragesPowerOfAttorneyStatusApiDTO(
                signed = True,
    ...
    def testDebituraWebExternalCustomerAPIModelsCoveragesPowerOfAttorneyStatusApiDTO(self):
        """Test DebituraWebExternalCustomerAPIModelsCoveragesPowerOfAttorneyStatusApiDTO"""
