...
class TestDebituraDomainModelWebhooksDtosWebhookDto(unittest.TestCase):
    """DebituraDomainModelWebhooksDtosWebhookDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraDomainModelWebhooksDtosWebhookDto:
        """Test DebituraDomainModelWebhooksDtosWebhookDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraDomainModelWebhooksDtosWebhookDto`
        """
        model = DebituraDomainModelWebhooksDtosWebhookDto()
        if include_optional:
            return DebituraDomainModelWebhooksDtosWebhookDto(
                id = '',
                url = '',
                events = [
                    ''
    ...
    def testDebituraDomainModelWebhooksDtosWebhookDto(self):
        """Test DebituraDomainModelWebhooksDtosWebhookDto"""
