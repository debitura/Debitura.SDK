...
class TestDebituraWebExternalCustomerAPIModelsCoveragesCollectionContractStatusApiDTO(unittest.TestCase):
    """DebituraWebExternalCustomerAPIModelsCoveragesCollectionContractStatusApiDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalCustomerAPIModelsCoveragesCollectionContractStatusApiDTO:
        """Test DebituraWebExternalCustomerAPIModelsCoveragesCollectionContractStatusApiDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalCustomerAPIModelsCoveragesCollectionContractStatusApiDTO`
        """
        model = DebituraWebExternalCustomerAPIModelsCoveragesCollectionContractStatusApiDTO()
        if include_optional:
            return DebituraWebExternalCustomerAPIModelsCoveragesCollectionContractStatusApiDTO(
                signed = True,
    ...
    def testDebituraWebExternalCustomerAPIModelsCoveragesCollectionContractStatusApiDTO(self):
        """Test DebituraWebExternalCustomerAPIModelsCoveragesCollectionContractStatusApiDTO"""
