...
class TestDebituraWebExternalApiContractsV1CasesInvoiceAllocationOutstandingDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesInvoiceAllocationOutstandingDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesInvoiceAllocationOutstandingDto:
        """Test DebituraWebExternalApiContractsV1CasesInvoiceAllocationOutstandingDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesInvoiceAllocationOutstandingDto`
        """
        model = DebituraWebExternalApiContractsV1CasesInvoiceAllocationOutstandingDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesInvoiceAllocationOutstandingDto(
                principal = 1.337,
                interest = 1.337,
                reminder_fees = 1.337,
    ...
    def testDebituraWebExternalApiContractsV1CasesInvoiceAllocationOutstandingDto(self):
        """Test DebituraWebExternalApiContractsV1CasesInvoiceAllocationOutstandingDto"""
