...
class TestDebituraWebExternalApiContractsV1FilesCaseFileDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1FilesCaseFileDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1FilesCaseFileDto:
        """Test DebituraWebExternalApiContractsV1FilesCaseFileDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1FilesCaseFileDto`
        """
        model = DebituraWebExternalApiContractsV1FilesCaseFileDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1FilesCaseFileDto(
                id = '',
    ...
    def testDebituraWebExternalApiContractsV1FilesCaseFileDto(self):
        """Test DebituraWebExternalApiContractsV1FilesCaseFileDto"""
