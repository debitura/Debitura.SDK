...
class TestDebituraWebExternalApiContractsV1CasesFireWebhookResponse(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesFireWebhookResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesFireWebhookResponse:
        """Test DebituraWebExternalApiContractsV1CasesFireWebhookResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesFireWebhookResponse`
        """
        model = DebituraWebExternalApiContractsV1CasesFireWebhookResponse()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesFireWebhookResponse(
                event_type = '',
                case_id = '',
                enqueued_count = 56
            )
    ...
    def testDebituraWebExternalApiContractsV1CasesFireWebhookResponse(self):
        """Test DebituraWebExternalApiContractsV1CasesFireWebhookResponse"""
