...
class TestDebituraWebExternalCustomerAPIModelsCoveragesCaseEligibilityRequestApiDTO(unittest.TestCase):
    """DebituraWebExternalCustomerAPIModelsCoveragesCaseEligibilityRequestApiDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalCustomerAPIModelsCoveragesCaseEligibilityRequestApiDTO:
        """Test DebituraWebExternalCustomerAPIModelsCoveragesCaseEligibilityRequestApiDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalCustomerAPIModelsCoveragesCaseEligibilityRequestApiDTO`
        """
        model = DebituraWebExternalCustomerAPIModelsCoveragesCaseEligibilityRequestApiDTO()
        if include_optional:
            return DebituraWebExternalCustomerAPIModelsCoveragesCaseEligibilityRequestApiDTO(
                country_alpha2 = '0',
                state_alpha2 = '',
                debtor_type = '0',
                amount = 0.01,
    ...
    def testDebituraWebExternalCustomerAPIModelsCoveragesCaseEligibilityRequestApiDTO(self):
        """Test DebituraWebExternalCustomerAPIModelsCoveragesCaseEligibilityRequestApiDTO"""
