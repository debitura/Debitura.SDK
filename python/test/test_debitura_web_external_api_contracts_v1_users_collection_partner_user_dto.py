...
class TestDebituraWebExternalApiContractsV1UsersCollectionPartnerUserDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1UsersCollectionPartnerUserDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1UsersCollectionPartnerUserDto:
        """Test DebituraWebExternalApiContractsV1UsersCollectionPartnerUserDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1UsersCollectionPartnerUserDto`
        """
        model = DebituraWebExternalApiContractsV1UsersCollectionPartnerUserDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1UsersCollectionPartnerUserDto(
                id = '',
                name = '',
                email = ''
            )
    ...
    def testDebituraWebExternalApiContractsV1UsersCollectionPartnerUserDto(self):
        """Test DebituraWebExternalApiContractsV1UsersCollectionPartnerUserDto"""
