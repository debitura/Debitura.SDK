...
class TestDebituraWebExternalApiContractsV1CasesJurisdictionDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesJurisdictionDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesJurisdictionDto:
        """Test DebituraWebExternalApiContractsV1CasesJurisdictionDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesJurisdictionDto`
        """
        model = DebituraWebExternalApiContractsV1CasesJurisdictionDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesJurisdictionDto(
                id = 56,
                name = '',
                country_alpha2 = '',
                state_alpha2 = ''
    ...
    def testDebituraWebExternalApiContractsV1CasesJurisdictionDto(self):
        """Test DebituraWebExternalApiContractsV1CasesJurisdictionDto"""
