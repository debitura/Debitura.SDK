...
class TestDebituraWebExternalApiContractsV1CasesBusinessErrorApiDTO(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesBusinessErrorApiDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesBusinessErrorApiDTO:
        """Test DebituraWebExternalApiContractsV1CasesBusinessErrorApiDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesBusinessErrorApiDTO`
        """
        model = DebituraWebExternalApiContractsV1CasesBusinessErrorApiDTO()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesBusinessErrorApiDTO(
                type = '',
                message = '',
                solution_url = ''
            )
    ...
    def testDebituraWebExternalApiContractsV1CasesBusinessErrorApiDTO(self):
        """Test DebituraWebExternalApiContractsV1CasesBusinessErrorApiDTO"""
