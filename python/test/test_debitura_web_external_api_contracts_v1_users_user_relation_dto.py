...
class TestDebituraWebExternalApiContractsV1UsersUserRelationDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1UsersUserRelationDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1UsersUserRelationDto:
        """Test DebituraWebExternalApiContractsV1UsersUserRelationDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1UsersUserRelationDto`
        """
        model = DebituraWebExternalApiContractsV1UsersUserRelationDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1UsersUserRelationDto(
                id = 56,
    ...
    def testDebituraWebExternalApiContractsV1UsersUserRelationDto(self):
        """Test DebituraWebExternalApiContractsV1UsersUserRelationDto"""
