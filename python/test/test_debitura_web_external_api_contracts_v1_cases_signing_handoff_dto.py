...
class TestDebituraWebExternalApiContractsV1CasesSigningHandoffDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesSigningHandoffDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesSigningHandoffDto:
        """Test DebituraWebExternalApiContractsV1CasesSigningHandoffDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesSigningHandoffDto`
        """
        model = DebituraWebExternalApiContractsV1CasesSigningHandoffDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesSigningHandoffDto(
    ...
    def testDebituraWebExternalApiContractsV1CasesSigningHandoffDto(self):
        """Test DebituraWebExternalApiContractsV1CasesSigningHandoffDto"""
