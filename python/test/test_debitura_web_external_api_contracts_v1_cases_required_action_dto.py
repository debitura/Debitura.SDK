...
class TestDebituraWebExternalApiContractsV1CasesRequiredActionDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesRequiredActionDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesRequiredActionDto:
        """Test DebituraWebExternalApiContractsV1CasesRequiredActionDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesRequiredActionDto`
        """
        model = DebituraWebExternalApiContractsV1CasesRequiredActionDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesRequiredActionDto(
                type = '',
                message = '',
                solution_url = '',
                is_blocking = True
    ...
    def testDebituraWebExternalApiContractsV1CasesRequiredActionDto(self):
        """Test DebituraWebExternalApiContractsV1CasesRequiredActionDto"""
