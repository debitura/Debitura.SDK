...
class TestDebituraWebExternalApiContractsV1CasesBankAccountDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesBankAccountDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesBankAccountDto:
        """Test DebituraWebExternalApiContractsV1CasesBankAccountDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesBankAccountDto`
        """
        model = DebituraWebExternalApiContractsV1CasesBankAccountDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesBankAccountDto(
                id = 56,
                label = '',
                scheme = '',
                currency_code = '',
    ...
    def testDebituraWebExternalApiContractsV1CasesBankAccountDto(self):
        """Test DebituraWebExternalApiContractsV1CasesBankAccountDto"""
