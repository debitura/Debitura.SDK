...
class TestDebituraWebExternalApiContractsV1CasesAssignedUserDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesAssignedUserDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesAssignedUserDto:
        """Test DebituraWebExternalApiContractsV1CasesAssignedUserDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesAssignedUserDto`
        """
        model = DebituraWebExternalApiContractsV1CasesAssignedUserDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesAssignedUserDto(
                email = '',
                name = ''
            )
        else:
    ...
    def testDebituraWebExternalApiContractsV1CasesAssignedUserDto(self):
        """Test DebituraWebExternalApiContractsV1CasesAssignedUserDto"""
