...
class TestDebituraWebExternalApiContractsV1CasesCaseValidationLeanDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesCaseValidationLeanDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesCaseValidationLeanDto:
        """Test DebituraWebExternalApiContractsV1CasesCaseValidationLeanDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesCaseValidationLeanDto`
        """
        model = DebituraWebExternalApiContractsV1CasesCaseValidationLeanDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesCaseValidationLeanDto(
                needs_info = True
            )
        else:
            return DebituraWebExternalApiContractsV1CasesCaseValidationLeanDto(
    ...
    def testDebituraWebExternalApiContractsV1CasesCaseValidationLeanDto(self):
        """Test DebituraWebExternalApiContractsV1CasesCaseValidationLeanDto"""
