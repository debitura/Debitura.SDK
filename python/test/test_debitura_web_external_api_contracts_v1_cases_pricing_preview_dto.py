...
class TestDebituraWebExternalApiContractsV1CasesPricingPreviewDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesPricingPreviewDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesPricingPreviewDto:
        """Test DebituraWebExternalApiContractsV1CasesPricingPreviewDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesPricingPreviewDto`
        """
        model = DebituraWebExternalApiContractsV1CasesPricingPreviewDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesPricingPreviewDto(
    ...
    def testDebituraWebExternalApiContractsV1CasesPricingPreviewDto(self):
        """Test DebituraWebExternalApiContractsV1CasesPricingPreviewDto"""
