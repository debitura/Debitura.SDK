...
class TestDebituraDomainModelWebhooksDtosUpdateWebhookRequest(unittest.TestCase):
    """DebituraDomainModelWebhooksDtosUpdateWebhookRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraDomainModelWebhooksDtosUpdateWebhookRequest:
        """Test DebituraDomainModelWebhooksDtosUpdateWebhookRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraDomainModelWebhooksDtosUpdateWebhookRequest`
        """
        model = DebituraDomainModelWebhooksDtosUpdateWebhookRequest()
        if include_optional:
            return DebituraDomainModelWebhooksDtosUpdateWebhookRequest(
                url = '',
                events = [
                    ''
                    ],
    ...
    def testDebituraDomainModelWebhooksDtosUpdateWebhookRequest(self):
        """Test DebituraDomainModelWebhooksDtosUpdateWebhookRequest"""
