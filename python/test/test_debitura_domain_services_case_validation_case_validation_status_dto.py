...
class TestDebituraDomainServicesCaseValidationCaseValidationStatusDto(unittest.TestCase):
    """DebituraDomainServicesCaseValidationCaseValidationStatusDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraDomainServicesCaseValidationCaseValidationStatusDto:
        """Test DebituraDomainServicesCaseValidationCaseValidationStatusDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraDomainServicesCaseValidationCaseValidationStatusDto`
        """
        model = DebituraDomainServicesCaseValidationCaseValidationStatusDto()
        if include_optional:
            return DebituraDomainServicesCaseValidationCaseValidationStatusDto(
                needs_info = True,
                creditor_responded_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                items = [
                    debitura_debt_collection.models.debitura/domain/services/case_validation/case_validation_item_dto.Debitura.Domain.Services.CaseValidation.CaseValidationItemDto(
                        resolution_area = '', 
                        description = '', )
                    ]
            )
    ...
    def testDebituraDomainServicesCaseValidationCaseValidationStatusDto(self):
        """Test DebituraDomainServicesCaseValidationCaseValidationStatusDto"""
