...
class TestDebituraWebExternalCustomerAPIModelsWebhooksDtosTestResultDto(unittest.TestCase):
    """DebituraWebExternalCustomerAPIModelsWebhooksDtosTestResultDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalCustomerAPIModelsWebhooksDtosTestResultDto:
        """Test DebituraWebExternalCustomerAPIModelsWebhooksDtosTestResultDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalCustomerAPIModelsWebhooksDtosTestResultDto`
        """
        model = DebituraWebExternalCustomerAPIModelsWebhooksDtosTestResultDto()
        if include_optional:
            return DebituraWebExternalCustomerAPIModelsWebhooksDtosTestResultDto(
                success = True,
                http_status_code = 56,
                duration_ms = 56,
                error_message = '',
    ...
    def testDebituraWebExternalCustomerAPIModelsWebhooksDtosTestResultDto(self):
        """Test DebituraWebExternalCustomerAPIModelsWebhooksDtosTestResultDto"""
