...
class TestDebituraWebExternalApiContractsV1CasesContractItemDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesContractItemDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesContractItemDto:
        """Test DebituraWebExternalApiContractsV1CasesContractItemDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesContractItemDto`
        """
        model = DebituraWebExternalApiContractsV1CasesContractItemDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesContractItemDto(
                signed = True,
    ...
    def testDebituraWebExternalApiContractsV1CasesContractItemDto(self):
        """Test DebituraWebExternalApiContractsV1CasesContractItemDto"""
