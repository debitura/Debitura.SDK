...
class TestDebituraWebExternalCustomerAPIModelsWebhooksRequestsReplayRequestDto(unittest.TestCase):
    """DebituraWebExternalCustomerAPIModelsWebhooksRequestsReplayRequestDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalCustomerAPIModelsWebhooksRequestsReplayRequestDto:
        """Test DebituraWebExternalCustomerAPIModelsWebhooksRequestsReplayRequestDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalCustomerAPIModelsWebhooksRequestsReplayRequestDto`
        """
        model = DebituraWebExternalCustomerAPIModelsWebhooksRequestsReplayRequestDto()
        if include_optional:
            return DebituraWebExternalCustomerAPIModelsWebhooksRequestsReplayRequestDto(
                since_utc = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f')
            )
        else:
            return DebituraWebExternalCustomerAPIModelsWebhooksRequestsReplayRequestDto(
                since_utc = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
    ...
    def testDebituraWebExternalCustomerAPIModelsWebhooksRequestsReplayRequestDto(self):
        """Test DebituraWebExternalCustomerAPIModelsWebhooksRequestsReplayRequestDto"""
