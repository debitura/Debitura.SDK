...
class TestDebituraDomainModelWebhooksDtosCreateWebhookRequest(unittest.TestCase):
    """DebituraDomainModelWebhooksDtosCreateWebhookRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraDomainModelWebhooksDtosCreateWebhookRequest:
        """Test DebituraDomainModelWebhooksDtosCreateWebhookRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraDomainModelWebhooksDtosCreateWebhookRequest`
        """
        model = DebituraDomainModelWebhooksDtosCreateWebhookRequest()
        if include_optional:
            return DebituraDomainModelWebhooksDtosCreateWebhookRequest(
                url = '',
                events = [
                    ''
                    ],
    ...
    def testDebituraDomainModelWebhooksDtosCreateWebhookRequest(self):
        """Test DebituraDomainModelWebhooksDtosCreateWebhookRequest"""
