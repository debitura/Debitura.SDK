...
class TestDebituraWebExternalCustomerAPIModelsCoveragesJurisdictionInfoApiDTO(unittest.TestCase):
    """DebituraWebExternalCustomerAPIModelsCoveragesJurisdictionInfoApiDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalCustomerAPIModelsCoveragesJurisdictionInfoApiDTO:
        """Test DebituraWebExternalCustomerAPIModelsCoveragesJurisdictionInfoApiDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalCustomerAPIModelsCoveragesJurisdictionInfoApiDTO`
        """
        model = DebituraWebExternalCustomerAPIModelsCoveragesJurisdictionInfoApiDTO()
        if include_optional:
            return DebituraWebExternalCustomerAPIModelsCoveragesJurisdictionInfoApiDTO(
                id = 56,
                name = '',
                country = '',
                country_alpha2 = '',
    ...
    def testDebituraWebExternalCustomerAPIModelsCoveragesJurisdictionInfoApiDTO(self):
        """Test DebituraWebExternalCustomerAPIModelsCoveragesJurisdictionInfoApiDTO"""
