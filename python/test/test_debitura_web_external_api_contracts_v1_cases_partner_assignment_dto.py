...
class TestDebituraWebExternalApiContractsV1CasesPartnerAssignmentDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesPartnerAssignmentDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesPartnerAssignmentDto:
        """Test DebituraWebExternalApiContractsV1CasesPartnerAssignmentDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesPartnerAssignmentDto`
        """
        model = DebituraWebExternalApiContractsV1CasesPartnerAssignmentDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesPartnerAssignmentDto(
    ...
    def testDebituraWebExternalApiContractsV1CasesPartnerAssignmentDto(self):
        """Test DebituraWebExternalApiContractsV1CasesPartnerAssignmentDto"""
