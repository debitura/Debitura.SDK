...
class TestDebituraWebExternalApiContractsV1LeadsLeadQuoteDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1LeadsLeadQuoteDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1LeadsLeadQuoteDto:
        """Test DebituraWebExternalApiContractsV1LeadsLeadQuoteDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1LeadsLeadQuoteDto`
        """
        model = DebituraWebExternalApiContractsV1LeadsLeadQuoteDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1LeadsLeadQuoteDto(
                quote_id = '',
                quote_request_id = '',
                partner_id = '',
                partner_name = '',
    ...
    def testDebituraWebExternalApiContractsV1LeadsLeadQuoteDto(self):
        """Test DebituraWebExternalApiContractsV1LeadsLeadQuoteDto"""
