...
class TestDebituraWebExternalApiContractsV1CasesRequestsAdvanceTestCaseRequest(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesRequestsAdvanceTestCaseRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesRequestsAdvanceTestCaseRequest:
        """Test DebituraWebExternalApiContractsV1CasesRequestsAdvanceTestCaseRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesRequestsAdvanceTestCaseRequest`
        """
        model = DebituraWebExternalApiContractsV1CasesRequestsAdvanceTestCaseRequest()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesRequestsAdvanceTestCaseRequest(
                to = 'Active',
                amount = 1500.0
            )
        else:
    ...
    def testDebituraWebExternalApiContractsV1CasesRequestsAdvanceTestCaseRequest(self):
        """Test DebituraWebExternalApiContractsV1CasesRequestsAdvanceTestCaseRequest"""
