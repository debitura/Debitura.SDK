...
class TestDebituraWebExternalApiContractsV1CasesTimelineRelatedCaseDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesTimelineRelatedCaseDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesTimelineRelatedCaseDto:
        """Test DebituraWebExternalApiContractsV1CasesTimelineRelatedCaseDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesTimelineRelatedCaseDto`
        """
        model = DebituraWebExternalApiContractsV1CasesTimelineRelatedCaseDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesTimelineRelatedCaseDto(
                id = '',
                reference = ''
            )
        else:
    ...
    def testDebituraWebExternalApiContractsV1CasesTimelineRelatedCaseDto(self):
        """Test DebituraWebExternalApiContractsV1CasesTimelineRelatedCaseDto"""
