...
class TestDebituraWebExternalApiContractsV1CasesCollectionPartnerDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesCollectionPartnerDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesCollectionPartnerDto:
        """Test DebituraWebExternalApiContractsV1CasesCollectionPartnerDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesCollectionPartnerDto`
        """
        model = DebituraWebExternalApiContractsV1CasesCollectionPartnerDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesCollectionPartnerDto(
                name = '',
                office_email = '',
                office_phone = '',
                public_site = '',
    ...
    def testDebituraWebExternalApiContractsV1CasesCollectionPartnerDto(self):
        """Test DebituraWebExternalApiContractsV1CasesCollectionPartnerDto"""
