...
class TestDebituraDomainServicesCaseValidationCaseValidationLeanDto(unittest.TestCase):
    """DebituraDomainServicesCaseValidationCaseValidationLeanDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraDomainServicesCaseValidationCaseValidationLeanDto:
        """Test DebituraDomainServicesCaseValidationCaseValidationLeanDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraDomainServicesCaseValidationCaseValidationLeanDto`
        """
        model = DebituraDomainServicesCaseValidationCaseValidationLeanDto()
        if include_optional:
            return DebituraDomainServicesCaseValidationCaseValidationLeanDto(
                needs_info = True
            )
        else:
            return DebituraDomainServicesCaseValidationCaseValidationLeanDto(
    ...
    def testDebituraDomainServicesCaseValidationCaseValidationLeanDto(self):
        """Test DebituraDomainServicesCaseValidationCaseValidationLeanDto"""
