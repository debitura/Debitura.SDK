...
class TestCoverageApi(unittest.TestCase):
    ...
    def test_coverage_check_eligibility_post(self) -> None:
        """Test case for coverage_check_eligibility_post

        Check case eligibility and get assigned partner
        """
        pass

    def test_coverage_get(self) -> None:
    ...
    def test_coverage_id_get(self) -> None:
        """Test case for coverage_id_get

        Get jurisdiction coverage by ID
        """
        pass

    def test_coverage_search_get(self) -> None:
        """Test case for coverage_search_get

        [DEPRECATED] Search for jurisdiction coverage
        """
        pass

    def test_coverage_search_get_0(self) -> None:
        """Test case for coverage_search_get_0
