...
class TestDebituraWebExternalApiContractsV1CasesCreditorDivisionDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesCreditorDivisionDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesCreditorDivisionDto:
        """Test DebituraWebExternalApiContractsV1CasesCreditorDivisionDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesCreditorDivisionDto`
        """
        model = DebituraWebExternalApiContractsV1CasesCreditorDivisionDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesCreditorDivisionDto(
                id = '',
                name = ''
            )
        else:
    ...
    def testDebituraWebExternalApiContractsV1CasesCreditorDivisionDto(self):
        """Test DebituraWebExternalApiContractsV1CasesCreditorDivisionDto"""
