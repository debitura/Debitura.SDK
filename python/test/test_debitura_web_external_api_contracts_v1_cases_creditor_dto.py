...
class TestDebituraWebExternalApiContractsV1CasesCreditorDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesCreditorDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesCreditorDto:
        """Test DebituraWebExternalApiContractsV1CasesCreditorDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesCreditorDto`
        """
        model = DebituraWebExternalApiContractsV1CasesCreditorDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesCreditorDto(
                id = '',
                company_name = '',
    ...
    def testDebituraWebExternalApiContractsV1CasesCreditorDto(self):
        """Test DebituraWebExternalApiContractsV1CasesCreditorDto"""
