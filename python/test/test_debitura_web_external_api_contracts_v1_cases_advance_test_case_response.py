...
class TestDebituraWebExternalApiContractsV1CasesAdvanceTestCaseResponse(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesAdvanceTestCaseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesAdvanceTestCaseResponse:
        """Test DebituraWebExternalApiContractsV1CasesAdvanceTestCaseResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesAdvanceTestCaseResponse`
        """
        model = DebituraWebExternalApiContractsV1CasesAdvanceTestCaseResponse()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesAdvanceTestCaseResponse(
                advanced = True,
                state = ''
            )
        else:
    ...
    def testDebituraWebExternalApiContractsV1CasesAdvanceTestCaseResponse(self):
        """Test DebituraWebExternalApiContractsV1CasesAdvanceTestCaseResponse"""
