...
class TestDebituraWebExternalApiContractsV1LeadsLeadQuoteListDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1LeadsLeadQuoteListDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1LeadsLeadQuoteListDto:
        """Test DebituraWebExternalApiContractsV1LeadsLeadQuoteListDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1LeadsLeadQuoteListDto`
        """
        model = DebituraWebExternalApiContractsV1LeadsLeadQuoteListDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1LeadsLeadQuoteListDto(
                quotes = [
                    debitura_debt_collection.models.debitura/web/external_api/contracts/v1/leads/lead_quote_dto.Debitura.Web.ExternalApi.Contracts.V1.Leads.LeadQuoteDto(
                        quote_id = '', 
                        quote_request_id = '', 
                        partner_id = '', 
                        partner_name = '', 
    ...
    def testDebituraWebExternalApiContractsV1LeadsLeadQuoteListDto(self):
        """Test DebituraWebExternalApiContractsV1LeadsLeadQuoteListDto"""
