...
class TestDebituraWebExternalCustomerAPIModelsCoveragesPartnerCoverageApiDTO(unittest.TestCase):
    """DebituraWebExternalCustomerAPIModelsCoveragesPartnerCoverageApiDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalCustomerAPIModelsCoveragesPartnerCoverageApiDTO:
        """Test DebituraWebExternalCustomerAPIModelsCoveragesPartnerCoverageApiDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalCustomerAPIModelsCoveragesPartnerCoverageApiDTO`
        """
        model = DebituraWebExternalCustomerAPIModelsCoveragesPartnerCoverageApiDTO()
        if include_optional:
            return DebituraWebExternalCustomerAPIModelsCoveragesPartnerCoverageApiDTO(
                partner_id = '',
                partner_name = '',
                conditions = '',
                signed = True,
    ...
    def testDebituraWebExternalCustomerAPIModelsCoveragesPartnerCoverageApiDTO(self):
        """Test DebituraWebExternalCustomerAPIModelsCoveragesPartnerCoverageApiDTO"""
