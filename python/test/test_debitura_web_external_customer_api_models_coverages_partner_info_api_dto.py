...
class TestDebituraWebExternalCustomerAPIModelsCoveragesPartnerInfoApiDTO(unittest.TestCase):
    """DebituraWebExternalCustomerAPIModelsCoveragesPartnerInfoApiDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalCustomerAPIModelsCoveragesPartnerInfoApiDTO:
        """Test DebituraWebExternalCustomerAPIModelsCoveragesPartnerInfoApiDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalCustomerAPIModelsCoveragesPartnerInfoApiDTO`
        """
        model = DebituraWebExternalCustomerAPIModelsCoveragesPartnerInfoApiDTO()
        if include_optional:
            return DebituraWebExternalCustomerAPIModelsCoveragesPartnerInfoApiDTO(
                id = '',
                name = ''
            )
        else:
    ...
    def testDebituraWebExternalCustomerAPIModelsCoveragesPartnerInfoApiDTO(self):
        """Test DebituraWebExternalCustomerAPIModelsCoveragesPartnerInfoApiDTO"""
