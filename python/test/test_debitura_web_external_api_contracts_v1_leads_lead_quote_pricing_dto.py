...
class TestDebituraWebExternalApiContractsV1LeadsLeadQuotePricingDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1LeadsLeadQuotePricingDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1LeadsLeadQuotePricingDto:
        """Test DebituraWebExternalApiContractsV1LeadsLeadQuotePricingDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1LeadsLeadQuotePricingDto`
        """
        model = DebituraWebExternalApiContractsV1LeadsLeadQuotePricingDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1LeadsLeadQuotePricingDto(
                hourly_rate = 1.337,
    ...
    def testDebituraWebExternalApiContractsV1LeadsLeadQuotePricingDto(self):
        """Test DebituraWebExternalApiContractsV1LeadsLeadQuotePricingDto"""
