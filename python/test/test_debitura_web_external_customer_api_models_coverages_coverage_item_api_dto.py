...
class TestDebituraWebExternalCustomerAPIModelsCoveragesCoverageItemApiDTO(unittest.TestCase):
    """DebituraWebExternalCustomerAPIModelsCoveragesCoverageItemApiDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalCustomerAPIModelsCoveragesCoverageItemApiDTO:
        """Test DebituraWebExternalCustomerAPIModelsCoveragesCoverageItemApiDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalCustomerAPIModelsCoveragesCoverageItemApiDTO`
        """
        model = DebituraWebExternalCustomerAPIModelsCoveragesCoverageItemApiDTO()
        if include_optional:
            return DebituraWebExternalCustomerAPIModelsCoveragesCoverageItemApiDTO(
                jurisdiction = '',
                jurisdiction_id = 56,
                country = '',
                country_id = 56,
                ...
                us_state_alpha2 = '',
                partners = [
                    debitura_debt_collection.models.debitura/web/external_customer_api/models/coverages/partner_coverage_api_dto.Debitura.Web.ExternalCustomerAPI.Models.Coverages.PartnerCoverageApiDTO(
                        partner_id = '', 
                        partner_name = '', 
                        conditions = '', 
                        signed = True, 
    ...
    def testDebituraWebExternalCustomerAPIModelsCoveragesCoverageItemApiDTO(self):
        """Test DebituraWebExternalCustomerAPIModelsCoveragesCoverageItemApiDTO"""
