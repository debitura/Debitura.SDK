...
class TestDebituraWebExternalApiContractsV1DivisionsUpdateDivisionRequestDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1DivisionsUpdateDivisionRequestDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1DivisionsUpdateDivisionRequestDto:
        """Test DebituraWebExternalApiContractsV1DivisionsUpdateDivisionRequestDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1DivisionsUpdateDivisionRequestDto`
        """
        model = DebituraWebExternalApiContractsV1DivisionsUpdateDivisionRequestDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1DivisionsUpdateDivisionRequestDto(
                company_name = '',
                registration_number = '',
                address = '',
                zip_code = '',
    ...
    def testDebituraWebExternalApiContractsV1DivisionsUpdateDivisionRequestDto(self):
        """Test DebituraWebExternalApiContractsV1DivisionsUpdateDivisionRequestDto"""
