...
class TestDebituraWebExternalApiContractsV1TasksTaskActionDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1TasksTaskActionDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1TasksTaskActionDto:
        """Test DebituraWebExternalApiContractsV1TasksTaskActionDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1TasksTaskActionDto`
        """
        model = DebituraWebExternalApiContractsV1TasksTaskActionDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1TasksTaskActionDto(
                method = '',
                path = ''
            )
        else:
    ...
    def testDebituraWebExternalApiContractsV1TasksTaskActionDto(self):
        """Test DebituraWebExternalApiContractsV1TasksTaskActionDto"""
