...
class TestDebituraWebExternalApiContractsV1PaymentsPaymentRelatedInvoiceDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1PaymentsPaymentRelatedInvoiceDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1PaymentsPaymentRelatedInvoiceDto:
        """Test DebituraWebExternalApiContractsV1PaymentsPaymentRelatedInvoiceDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1PaymentsPaymentRelatedInvoiceDto`
        """
        model = DebituraWebExternalApiContractsV1PaymentsPaymentRelatedInvoiceDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1PaymentsPaymentRelatedInvoiceDto(
                status = '',
                reference = '',
                invoice_id = ''
            )
    ...
    def testDebituraWebExternalApiContractsV1PaymentsPaymentRelatedInvoiceDto(self):
        """Test DebituraWebExternalApiContractsV1PaymentsPaymentRelatedInvoiceDto"""
