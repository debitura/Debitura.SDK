...
class TestDebituraWebExternalApiContractsV1PageData(unittest.TestCase):
    """DebituraWebExternalApiContractsV1PageData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1PageData:
        """Test DebituraWebExternalApiContractsV1PageData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1PageData`
        """
        model = DebituraWebExternalApiContractsV1PageData()
        if include_optional:
            return DebituraWebExternalApiContractsV1PageData(
                total_results = 56,
                page_size = 56,
                current_page = 56,
                response_count = 56,
    ...
    def testDebituraWebExternalApiContractsV1PageData(self):
        """Test DebituraWebExternalApiContractsV1PageData"""
