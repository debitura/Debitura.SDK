...
class TestDebituraWebExternalApiContractsV1CasesDebtorDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesDebtorDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesDebtorDto:
        """Test DebituraWebExternalApiContractsV1CasesDebtorDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesDebtorDto`
        """
        model = DebituraWebExternalApiContractsV1CasesDebtorDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesDebtorDto(
                type = 'Company',
    ...
    def testDebituraWebExternalApiContractsV1CasesDebtorDto(self):
        """Test DebituraWebExternalApiContractsV1CasesDebtorDto"""
