...
class TestDebituraWebExternalApiContractsV1ChatsSendChatRequest(unittest.TestCase):
    """DebituraWebExternalApiContractsV1ChatsSendChatRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1ChatsSendChatRequest:
        """Test DebituraWebExternalApiContractsV1ChatsSendChatRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1ChatsSendChatRequest`
        """
        model = DebituraWebExternalApiContractsV1ChatsSendChatRequest()
        if include_optional:
            return DebituraWebExternalApiContractsV1ChatsSendChatRequest(
    ...
    def testDebituraWebExternalApiContractsV1ChatsSendChatRequest(self):
        """Test DebituraWebExternalApiContractsV1ChatsSendChatRequest"""
