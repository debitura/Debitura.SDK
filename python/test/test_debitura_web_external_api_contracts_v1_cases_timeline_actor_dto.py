...
class TestDebituraWebExternalApiContractsV1CasesTimelineActorDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesTimelineActorDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesTimelineActorDto:
        """Test DebituraWebExternalApiContractsV1CasesTimelineActorDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesTimelineActorDto`
        """
        model = DebituraWebExternalApiContractsV1CasesTimelineActorDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesTimelineActorDto(
                type = '',
                name = ''
            )
        else:
    ...
    def testDebituraWebExternalApiContractsV1CasesTimelineActorDto(self):
        """Test DebituraWebExternalApiContractsV1CasesTimelineActorDto"""
