...
class TestDebituraWebExternalCustomerAPIModelsWebhooksDtosReplayEventResultDto(unittest.TestCase):
    """DebituraWebExternalCustomerAPIModelsWebhooksDtosReplayEventResultDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalCustomerAPIModelsWebhooksDtosReplayEventResultDto:
        """Test DebituraWebExternalCustomerAPIModelsWebhooksDtosReplayEventResultDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalCustomerAPIModelsWebhooksDtosReplayEventResultDto`
        """
        model = DebituraWebExternalCustomerAPIModelsWebhooksDtosReplayEventResultDto()
        if include_optional:
            return DebituraWebExternalCustomerAPIModelsWebhooksDtosReplayEventResultDto(
                event_id = '',
                subscription_id = '',
                event_type = ''
            )
    ...
    def testDebituraWebExternalCustomerAPIModelsWebhooksDtosReplayEventResultDto(self):
        """Test DebituraWebExternalCustomerAPIModelsWebhooksDtosReplayEventResultDto"""
