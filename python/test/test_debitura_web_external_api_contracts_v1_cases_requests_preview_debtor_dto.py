...
class TestDebituraWebExternalApiContractsV1CasesRequestsPreviewDebtorDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1CasesRequestsPreviewDebtorDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1CasesRequestsPreviewDebtorDto:
        """Test DebituraWebExternalApiContractsV1CasesRequestsPreviewDebtorDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1CasesRequestsPreviewDebtorDto`
        """
        model = DebituraWebExternalApiContractsV1CasesRequestsPreviewDebtorDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1CasesRequestsPreviewDebtorDto(
                type = '0',
                country_alpha2 = '01',
                state_alpha2 = '01'
            )
    ...
    def testDebituraWebExternalApiContractsV1CasesRequestsPreviewDebtorDto(self):
        """Test DebituraWebExternalApiContractsV1CasesRequestsPreviewDebtorDto"""
