...
class TestDebituraWebExternalApiContractsV1DivisionsDivisionDto(unittest.TestCase):
    """DebituraWebExternalApiContractsV1DivisionsDivisionDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebituraWebExternalApiContractsV1DivisionsDivisionDto:
        """Test DebituraWebExternalApiContractsV1DivisionsDivisionDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebituraWebExternalApiContractsV1DivisionsDivisionDto`
        """
        model = DebituraWebExternalApiContractsV1DivisionsDivisionDto()
        if include_optional:
            return DebituraWebExternalApiContractsV1DivisionsDivisionDto(
                id = '',
                company_name = '',
                registration_number = '',
                address = '',
    ...
    def testDebituraWebExternalApiContractsV1DivisionsDivisionDto(self):
        """Test DebituraWebExternalApiContractsV1DivisionsDivisionDto"""
