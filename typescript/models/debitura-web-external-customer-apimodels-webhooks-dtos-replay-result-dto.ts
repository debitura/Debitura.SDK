 ...
 * @export
 * @interface DebituraWebExternalCustomerAPIModelsWebhooksDtosReplayResultDto
 */
export interface DebituraWebExternalCustomerAPIModelsWebhooksDtosReplayResultDto {
    /**
     * Number of events that were re-enqueued for delivery.
     * @type {number}
     * @memberof DebituraWebExternalCustomerAPIModelsWebhooksDtosReplayResultDto
     */
