 ...
 * 
 * @export
 * @interface DebituraWebExternalApiContractsV1UsersUserRelationDto
 */
export interface DebituraWebExternalApiContractsV1UsersUserRelationDto {
    /**
     * 
     * @type {number}
     * @memberof DebituraWebExternalApiContractsV1UsersUserRelationDto
     */
    'id'?: number;
    /**
     * 
