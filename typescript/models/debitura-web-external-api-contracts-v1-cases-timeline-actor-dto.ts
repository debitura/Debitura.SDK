 ...
 * @export
 * @interface DebituraWebExternalApiContractsV1CasesTimelineActorDto
 */
export interface DebituraWebExternalApiContractsV1CasesTimelineActorDto {
    /**
     * The type of actor. One of: \"System\", \"Creditor user\", \"Partner user\".
     * @type {string}
     * @memberof DebituraWebExternalApiContractsV1CasesTimelineActorDto
     */
    'type': string | null;
    /**
