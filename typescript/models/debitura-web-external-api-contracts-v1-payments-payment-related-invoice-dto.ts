 ...
 * 
 * @export
 * @interface DebituraWebExternalApiContractsV1PaymentsPaymentRelatedInvoiceDto
 */
export interface DebituraWebExternalApiContractsV1PaymentsPaymentRelatedInvoiceDto {
    /**
     * 
     * @type {string}
     * @memberof DebituraWebExternalApiContractsV1PaymentsPaymentRelatedInvoiceDto
     */
    'status': string | null;
    /**
     * 
