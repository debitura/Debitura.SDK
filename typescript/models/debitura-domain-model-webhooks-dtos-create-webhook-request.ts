 ...
 * 
 * @export
 * @interface DebituraDomainModelWebhooksDtosCreateWebhookRequest
 */
export interface DebituraDomainModelWebhooksDtosCreateWebhookRequest {
    /**
     * 
     * @type {string}
     * @memberof DebituraDomainModelWebhooksDtosCreateWebhookRequest
     */
    'url': string;
    /**
     * 
