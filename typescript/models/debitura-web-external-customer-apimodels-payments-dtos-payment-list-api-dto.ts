...
// May contain unused imports in some cases
// @ts-ignore
import type { DebituraWebExternalApiContractsV1PaymentsPaymentDto } from './debitura-web-external-api-contracts-v1-payments-payment-dto';

/**
 * 
 * @export
 * @interface DebituraWebExternalCustomerAPIModelsPaymentsDtosPaymentListApiDTO
 */
export interface DebituraWebExternalCustomerAPIModelsPaymentsDtosPaymentListApiDTO {
    /**
     * 
     * @type {DebituraDomainModelBasePageData}
     * @memberof DebituraWebExternalCustomerAPIModelsPaymentsDtosPaymentListApiDTO
     */
    'page': DebituraDomainModelBasePageData;
    /**
     * 
     * @type {Array<DebituraWebExternalApiContractsV1PaymentsPaymentDto>}
     * @memberof DebituraWebExternalCustomerAPIModelsPaymentsDtosPaymentListApiDTO
     */
    'payments'?: Array<DebituraWebExternalApiContractsV1PaymentsPaymentDto> | null;
}
