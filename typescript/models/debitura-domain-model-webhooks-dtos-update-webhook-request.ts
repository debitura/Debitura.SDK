 ...
 * 
 * @export
 * @interface DebituraDomainModelWebhooksDtosUpdateWebhookRequest
 */
export interface DebituraDomainModelWebhooksDtosUpdateWebhookRequest {
    /**
     * 
     * @type {string}
     * @memberof DebituraDomainModelWebhooksDtosUpdateWebhookRequest
     */
    'url'?: string | null;
    /**
     * 
