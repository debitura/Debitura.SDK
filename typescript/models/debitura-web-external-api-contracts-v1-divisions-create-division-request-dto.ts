 ...
 * 
 * @export
 * @interface DebituraWebExternalApiContractsV1DivisionsCreateDivisionRequestDto
 */
export interface DebituraWebExternalApiContractsV1DivisionsCreateDivisionRequestDto {
    /**
     * 
     * @type {string}
     * @memberof DebituraWebExternalApiContractsV1DivisionsCreateDivisionRequestDto
     */
    'companyName': string;
    /**
     * 
