...
export const DebituraDomainModelCommunicationCenterChatsChatRole = {
    NUMBER_0: 0,
    NUMBER_1: 1,
    NUMBER_2: 2
} as const;

export type DebituraDomainModelCommunicationCenterChatsChatRole = typeof DebituraDomainModelCommunicationCenterChatsChatRole[keyof typeof DebituraDomainModelCommunicationCenterChatsChatRole];
