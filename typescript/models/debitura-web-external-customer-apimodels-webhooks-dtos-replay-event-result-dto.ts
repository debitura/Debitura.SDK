 ...
 * @export
 * @interface DebituraWebExternalCustomerAPIModelsWebhooksDtosReplayEventResultDto
 */
export interface DebituraWebExternalCustomerAPIModelsWebhooksDtosReplayEventResultDto {
    /**
     * The ID of the event that was replayed.
     * @type {string}
     * @memberof DebituraWebExternalCustomerAPIModelsWebhooksDtosReplayEventResultDto
     */
    'eventId'?: string;
    /**
    ...
    /**
     * The event type that was replayed.
     * @type {string}
     * @memberof DebituraWebExternalCustomerAPIModelsWebhooksDtosReplayEventResultDto
     */
