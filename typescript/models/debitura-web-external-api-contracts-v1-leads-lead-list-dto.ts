...
// @ts-ignore
import type { DebituraWebExternalApiContractsV1LeadsLeadDto } from './debitura-web-external-api-contracts-v1-leads-lead-dto';

/**
 * V1 Lead list response for external customer APIs
 * @export
 * @interface DebituraWebExternalApiContractsV1LeadsLeadListDto
 */
export interface DebituraWebExternalApiContractsV1LeadsLeadListDto {
    /**
     * 
     * @type {Array<DebituraWebExternalApiContractsV1LeadsLeadDto>}
     * @memberof DebituraWebExternalApiContractsV1LeadsLeadListDto
     */
    'quoteRequests': Array<DebituraWebExternalApiContractsV1LeadsLeadDto> | null;
}
