...
// @ts-ignore
import type { DebituraWebExternalApiContractsV1CasesPreviewResultDto } from './debitura-web-external-api-contracts-v1-cases-preview-result-dto';

/**
 * Response from previewing a case, showing eligibility, partner assignment, required actions, and pricing estimates.
 * @export
 * @interface DebituraWebExternalApiContractsV1CasesPreviewCaseResponseApiViewModel
 */
export interface DebituraWebExternalApiContractsV1CasesPreviewCaseResponseApiViewModel {
    /**
     * 
     * @type {DebituraWebExternalApiContractsV1CasesPreviewResultDto}
     * @memberof DebituraWebExternalApiContractsV1CasesPreviewCaseResponseApiViewModel
     */
    'result'?: DebituraWebExternalApiContractsV1CasesPreviewResultDto;
}
