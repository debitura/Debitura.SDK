 ...
 * 
 * @export
 * @interface DebituraWebExternalApiContractsV1DivisionsUpdateDivisionRequestDto
 */
export interface DebituraWebExternalApiContractsV1DivisionsUpdateDivisionRequestDto {
    /**
     * 
     * @type {string}
     * @memberof DebituraWebExternalApiContractsV1DivisionsUpdateDivisionRequestDto
     */
    'companyName': string;
    /**
     * 
