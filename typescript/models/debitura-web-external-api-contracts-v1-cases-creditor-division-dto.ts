 ...
 * @export
 * @interface DebituraWebExternalApiContractsV1CasesCreditorDivisionDto
 */
export interface DebituraWebExternalApiContractsV1CasesCreditorDivisionDto {
    /**
     * Unique identifier for the division
     * @type {string}
     * @memberof DebituraWebExternalApiContractsV1CasesCreditorDivisionDto
     */
    'id'?: string;
    /**
