 ...
 * 
 * @export
 * @interface DebituraDomainServicesCaseValidationCaseValidationLeanDto
 */
export interface DebituraDomainServicesCaseValidationCaseValidationLeanDto {
    /**
     * 
     * @type {boolean}
     * @memberof DebituraDomainServicesCaseValidationCaseValidationLeanDto
     */
    'needsInfo'?: boolean;
}
