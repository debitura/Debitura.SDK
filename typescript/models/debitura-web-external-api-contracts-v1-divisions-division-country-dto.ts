 ...
 * 
 * @export
 * @interface DebituraWebExternalApiContractsV1DivisionsDivisionCountryDto
 */
export interface DebituraWebExternalApiContractsV1DivisionsDivisionCountryDto {
    /**
     * 
     * @type {number}
     * @memberof DebituraWebExternalApiContractsV1DivisionsDivisionCountryDto
     */
    'id'?: number;
    /**
     * 
