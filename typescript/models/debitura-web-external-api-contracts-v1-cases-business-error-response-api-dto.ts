 ...
 * @export
 * @interface DebituraWebExternalApiContractsV1CasesBusinessErrorResponseApiDTO
 */
export interface DebituraWebExternalApiContractsV1CasesBusinessErrorResponseApiDTO {
    /**
     * List of business errors that must be resolved before the case can be created.
     * @type {Array<DebituraWebExternalApiContractsV1CasesBusinessErrorApiDTO>}
     * @memberof DebituraWebExternalApiContractsV1CasesBusinessErrorResponseApiDTO
     */
