...
// @ts-ignore
import type { DebituraDomainServicesCaseValidationCaseValidationItemDto } from './debitura-domain-services-case-validation-case-validation-item-dto';

/**
 * 
 * @export
 * @interface DebituraDomainServicesCaseValidationCaseValidationStatusDto
 */
export interface DebituraDomainServicesCaseValidationCaseValidationStatusDto {
    /**
     * 
     * @type {boolean}
     * @memberof DebituraDomainServicesCaseValidationCaseValidationStatusDto
     */
    'needsInfo'?: boolean;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<DebituraDomainServicesCaseValidationCaseValidationItemDto>}
     * @memberof DebituraDomainServicesCaseValidationCaseValidationStatusDto
     */
    'items'?: Array<DebituraDomainServicesCaseValidationCaseValidationItemDto> | null;
}
