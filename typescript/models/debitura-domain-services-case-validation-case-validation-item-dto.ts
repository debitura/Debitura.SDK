 ...
 * 
 * @export
 * @interface DebituraDomainServicesCaseValidationCaseValidationItemDto
 */
export interface DebituraDomainServicesCaseValidationCaseValidationItemDto {
    /**
     * 
     * @type {string}
     * @memberof DebituraDomainServicesCaseValidationCaseValidationItemDto
     */
