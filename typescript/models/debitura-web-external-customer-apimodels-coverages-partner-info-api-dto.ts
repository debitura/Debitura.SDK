 ...
 * Partner information
 * @export
 * @interface DebituraWebExternalCustomerAPIModelsCoveragesPartnerInfoApiDTO
 */
export interface DebituraWebExternalCustomerAPIModelsCoveragesPartnerInfoApiDTO {
    /**
     * 
     * @type {string}
     * @memberof DebituraWebExternalCustomerAPIModelsCoveragesPartnerInfoApiDTO
     */
    'id'?: string;
    /**
     * 
