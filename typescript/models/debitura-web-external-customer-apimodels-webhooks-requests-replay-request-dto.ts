 ...
 * @export
 * @interface DebituraWebExternalCustomerAPIModelsWebhooksRequestsReplayRequestDto
 */
export interface DebituraWebExternalCustomerAPIModelsWebhooksRequestsReplayRequestDto {
    /**
     * Replay all case.created events since this timestamp (UTC).
     * @type {string}
     * @memberof DebituraWebExternalCustomerAPIModelsWebhooksRequestsReplayRequestDto
     */
    'sinceUtc': string;
}
