 ...
 * @export
 * @interface DebituraWebExternalCustomerAPIModelsCoveragesJurisdictionInfoApiDTO
 */
export interface DebituraWebExternalCustomerAPIModelsCoveragesJurisdictionInfoApiDTO {
    /**
     * 
     * @type {number}
     * @memberof DebituraWebExternalCustomerAPIModelsCoveragesJurisdictionInfoApiDTO
     */
    'id'?: number;
    /**
     * 
