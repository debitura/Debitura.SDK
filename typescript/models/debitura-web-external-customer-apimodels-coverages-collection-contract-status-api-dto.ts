 ...
 * 
 * @export
 * @interface DebituraWebExternalCustomerAPIModelsCoveragesCollectionContractStatusApiDTO
 */
export interface DebituraWebExternalCustomerAPIModelsCoveragesCollectionContractStatusApiDTO {
    /**
     * 
     * @type {boolean}
     * @memberof DebituraWebExternalCustomerAPIModelsCoveragesCollectionContractStatusApiDTO
     */
    'signed'?: boolean;
    /**
     * 
