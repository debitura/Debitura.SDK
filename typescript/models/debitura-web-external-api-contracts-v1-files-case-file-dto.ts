 ...
 * 
 * @export
 * @interface DebituraWebExternalApiContractsV1FilesCaseFileDto
 */
export interface DebituraWebExternalApiContractsV1FilesCaseFileDto {
    /**
     * 
     * @type {string}
     * @memberof DebituraWebExternalApiContractsV1FilesCaseFileDto
     */
    'id'?: string;
    /**
     * 
