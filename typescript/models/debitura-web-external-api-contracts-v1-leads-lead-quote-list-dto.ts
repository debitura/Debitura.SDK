...
// @ts-ignore
import type { DebituraWebExternalApiContractsV1LeadsLeadQuoteDto } from './debitura-web-external-api-contracts-v1-leads-lead-quote-dto';

/**
 * V1 Lead Quote list response for external customer APIs
 * @export
 * @interface DebituraWebExternalApiContractsV1LeadsLeadQuoteListDto
 */
export interface DebituraWebExternalApiContractsV1LeadsLeadQuoteListDto {
    /**
     * 
     * @type {Array<DebituraWebExternalApiContractsV1LeadsLeadQuoteDto>}
     * @memberof DebituraWebExternalApiContractsV1LeadsLeadQuoteListDto
     */
    'quotes': Array<DebituraWebExternalApiContractsV1LeadsLeadQuoteDto> | null;
}
