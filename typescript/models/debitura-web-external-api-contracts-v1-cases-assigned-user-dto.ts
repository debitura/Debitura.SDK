 ...
 * @export
 * @interface DebituraWebExternalApiContractsV1CasesAssignedUserDto
 */
export interface DebituraWebExternalApiContractsV1CasesAssignedUserDto {
    /**
     * The assigned user\'s email address.
     * @type {string}
     * @memberof DebituraWebExternalApiContractsV1CasesAssignedUserDto
     */
    'email'?: string | null;
    /**
